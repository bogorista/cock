...
<div class="row tab-pane fade in active" role="tabpanel" id="projectdetails-tab">
            ...
            <div class="table-head"><?=$this->lang->line('application_assigned_agents');?>
             <span class="pull-right"> 
                  <a href="<?=base_url()?>projects/assign/<?=$project->id;?>" class="btn btn-primary tt" style="padding: 2px 5px 3px;" data-toggle="mainmodal" title="<?=$this->lang->line('application_change_agents');?>"><i class="fa fa-cog"></i>
                  </a>
            </span>
...
<?php foreach ($project->project_has_activities as $value):?>
                      ...
                      <div class="comment-content">
                          <h5><?=$value->subject;?></h5>
                            ...
                            <?php if($value->user_id == $this->user->id){ ?>
                            <a class="pull-right li-delete ajax-silent" href="<?=base_url();?>projects/activity/<?=$value->project_id;?>/delete/<?=$value->id;?>"><i class="ion-trash-b"></i></a>
                            <?php } ?>
                            </p>
                            <p><?=$value->message;?></p>
                      </div>
