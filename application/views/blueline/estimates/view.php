          ...
          <div class="row">
			...
			<?php if(($estimate->estimate_status == "Open" || $estimate->estimate_status == "Revised") && is_object($estimate->company)){ ?><a href="<?=base_url()?>estimates/sendestimate/<?=$estimate->id;?>" class="btn btn-primary"><i class="fa fa-envelope visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_send_estimate_to_client');?></span></a><?php } ?>
