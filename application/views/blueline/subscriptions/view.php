<div class="row">
        <div class="col-xs-12 col-sm-12">
			...
			<?php } ?>
			<?php if($subscription->status != "Paid" && is_object($subscription->company)){ ?><a href="<?=base_url()?>subscriptions/sendsubscription/<?=$subscription->id;?>" class="btn btn-primary"><i class="fa fa-envelope visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_send_subscription_to_client');?></span></a><?php } ?>
